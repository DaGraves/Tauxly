  ...
  return (
    <SafeAreaView>
      <ScrollView style={{margin: 10}}>
        ...
        <Text style={styles.paragraph}>Guidelines</Text>
        <Text style={styles.paragraph}>
          All reward payouts will be done via PayPal. User must have a PayPal
          account to receive their rewards.
        </Text>
        <Text style={styles.paragraph}>
          No nudity or adult content allowed. Post will be deleted and no refund
          will be available.
        </Text>
        <Text style={styles.paragraph}>Terms and Conditions</Text>
        <Text style={styles.paragraph}>
          These terms and conditions ("Agreement") set forth the general terms
          and conditions of your use of the "Tauxly" mobile application ("Mobile
          ...
          between you ("User", "you" or "your") and this Mobile Application
          developer ("Operator", "we", "us" or "our"). By accessing and using
          the Mobile Application and Services, you acknowledge that you have
          ...
          use the Mobile Application and Services. You acknowledge that this
        ...
        <Text style={styles.paragraph}>Accounts and membership</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>User content</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>Billing and payments</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>Accuracy of information</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>Backups</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>Links to other resources</Text>
        <Text style={styles.paragraph}>
          ...
          resource which you access through a link in the Mobile Application and
          Services. Your linking to any other off-site resources is at your own
          risk.
        </Text>
        <Text style={styles.paragraph}>Changes and amendments</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>Acceptance of these terms</Text>
        <Text style={styles.paragraph}>
        ...
        <Text style={styles.paragraph}>Contacting us</Text>
        <Text style={styles.paragraph}>
          If you would like to contact us to understand more about this
          Agreement or wish to contact us concerning any matter relating to it,
          you may send an email to tauxly@gmail.com.
        </Text>
        <Text style={styles.paragraph}>
          This document was last updated on April 21, 2021
        </Text>
      </ScrollView>
    </SafeAreaView>
  );
